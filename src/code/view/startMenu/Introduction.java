...
public class Introduction extends JPanel {
	...
	private void startGUI() {
		...
		taText.setText(
				...
				"peasants and will rise through the ranks when your total wealth reaches a certain number. Player one " +
				"will now begin by rolling the code.view.dice and then after that the player will press the end turn " +
				"button to let the next player begin his turn. To know more press the info button in the menu tab. " +
				"Now good luck on your adventures!  \r\n"
		);
