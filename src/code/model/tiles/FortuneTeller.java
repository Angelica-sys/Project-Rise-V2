 ...
 * @author SebastianViro, AevanDino, MuhammadAbdulkhuder, Tor Stenfeldt, Angelica Asplund
 */
public class FortuneTeller extends Tile {
	...
	public String getTileInfo() {
		return "There are two types of cards, blessings and curses." + 
				"\nBlessing affect the code.model.player in a positive way." +
				"\nCurses affect the code.model.player in a negative way.";
	}
}