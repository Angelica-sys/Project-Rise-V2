...
public class Dice extends JPanel implements ActionListener {
	 ...
	 * @param westSidePanel panel containing all the information about the view.westSidePanel.tiles and the history of all the controller.events
	...
	public void initializePanel() {
		...
		add(btnEndTurn);
//		add(view.cheat); //Enable for testing with cheater.
	...
	public void actionPerformed(ActionEvent e) {
		 ...
		 * If the model.player is not in jail they can roll the view.dice
		 */
